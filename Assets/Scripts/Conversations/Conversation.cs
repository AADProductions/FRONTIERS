...
namespace Frontiers.Story.Conversations
{
	...
	public class Conversation : MonoBehaviour
	{
		...
		//a little risky but whatever
		public static Action OnExchangeChosen;
		[NonSerialized]
		...
		public Transform CameraTarget {
			get {
				if (IsUsingIntermediary) {
					return Intermediary.CameraTarget;
				}
				return SpeakingCharacter.Body.Transforms.HeadConvo;
			}
		}

		public bool IsUsingIntermediary {
			get {
				return Intermediary != null;
			}
		}

		public IConversationIntermediary Intermediary;
		...
		{
			Initiate (speakingCharacter, talkative, null);
		}
