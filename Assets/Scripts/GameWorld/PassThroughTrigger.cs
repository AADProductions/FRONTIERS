...
namespace Frontiers.World
{
	public class PassThroughTrigger : MonoBehaviour
	{
		...
		public string IntersectFunctionName = string.Empty;
		...
		protected void OnIntersect () {
			if (!string.IsNullOrEmpty (IntersectFunctionName)) {
				TargetObject.SendMessage (IntersectFunctionName, SendMessageOptions.DontRequireReceiver);
			}
		}
