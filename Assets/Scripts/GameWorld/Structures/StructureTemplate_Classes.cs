...
namespace Frontiers.World
{
	public class StructureTemplateGroup
	{
		...
		//preloaded stuff
		[XmlIgnore]
		public List<ChildPiece> GenericWItemsPieces = new List<ChildPiece> ();
		[XmlIgnore]
		public List<ChildPiece> GenericWindowsPieces = new List<ChildPiece>();
		[XmlIgnore]
		public List<ChildPiece> GenericDoorsPieces = new List<ChildPiece>();
		[XmlIgnore]
		public List<ChildPiece> GenericDynamicPieces = new List<ChildPiece>();
		[XmlIgnore]
		public List<LightPiece> GenericLightsPieces = new List<LightPiece>();
		[XmlIgnore]
		public List<FXPiece> DestroyedFXPieces = new List<FXPiece>();
		[XmlIgnore]
		public List<ChildPiece> DestroyedFiresPieces = new List<ChildPiece>();
	...
	public class StructureLayer
	{
		...
		[XmlIgnore]
		public List <ChildPiece> InstancePieces = new List<ChildPiece>();
