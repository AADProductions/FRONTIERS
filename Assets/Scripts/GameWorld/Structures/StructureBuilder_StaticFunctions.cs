		...
		public partial class StructureBuilder : Builder
		{
						...
						Builder builder)
				{
						...
						for (int i = 0; i < structureColliders.Count; i++) {
								...
								StructureTemplate.ExtractChildPiecesFromLayer(childPieces, colliderLayer.Instances);
				...
				{
						List <ChildPiece> childPieces = new List<ChildPiece>();
						StructureTemplate.ExtractChildPiecesFromLayer(childPieces, pieces);
						for (int i = 0; i < childPieces.Count; i++) {
				...
				public static IEnumerator AddFiresToStructure(
						...
						Transform parentTransform)
				{
						List <ChildPiece> firePieces = new List<ChildPiece>();
						StructureTemplate.ExtractChildPiecesFromLayer(firePieces, fires);
