...
public class BodyAnimator : MonoBehaviour
{
		...
		public virtual void FixedUpdate()
		{
				...
				if (mToggle) {
						...
						mSmoothVerticalAxisMovement = Mathf.Lerp(mSmoothVerticalAxisMovement, VerticalAxisMovement, Time.deltaTime * 5f);
						mSmoothHorizontalAxisMovement = Mathf.Lerp(mSmoothHorizontalAxisMovement, HorizontalAxisMovement, Time.deltaTime * 5f);
						...
						animator.SetFloat("VerticalAxisMovement", mSmoothVerticalAxisMovement * MovementMultiplier);
