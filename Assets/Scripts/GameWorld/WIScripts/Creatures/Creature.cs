...
namespace Frontiers.World
{
		public class Creature : WIScript
		{
				...
				{
						MasterAudio.PlaySound(MasterAudio.SoundType.PlayerVoice, worlditem.tr, "EatFoodGeneric");
				...
				public MotileAction FleeFromFire()
				{
						...
						if (photosensitive.HasNearbyFires && worlditem.Is <Motile>(out motile)) {
								...
								if (mFleeThreatAction.IsFinished || mFleeThreatAction.LiveTarget != nearestFire.gameObject) {
										mFleeThreatAction.Reset();
