	...
	public class MissionCondition
	{
		public bool IsEmpty {
			get {
				...
				&& string.IsNullOrEmpty (SecondMissionName)
				&& string.IsNullOrEmpty (ObjectiveName)
				&& string.IsNullOrEmpty (SecondObjectiveName)
				&& string.IsNullOrEmpty (MissionVariableName);
			}
		}
