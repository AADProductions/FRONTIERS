...
namespace Frontiers.World.WIScripts
{
		public class Creature : WIScript
		{
				...
				{
						//this is the one bit that needs to be carried over
						bool isDead = State.IsDead;
						Reflection.CopyProperties(Template.StateTemplate, State);
						State.IsDead = isDead;
				...
				public void OnTakeDamage()
				{
						...
						if (Template.StateTemplate.Domestication == DomesticatedState.Wild) {
