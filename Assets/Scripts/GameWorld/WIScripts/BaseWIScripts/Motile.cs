...
namespace Frontiers.World.WIScripts
{
	...
	public class Motile : WIScript, IBodyOwner
	{
		...
		public bool IsImmobilized {
			get {
				return mIsImmobilized || !worlditem.CollisionsEnabled;
			}
			set {
		...
		protected bool mGroundedLastFrame = false;
		...
		public override void OnInitialized ()
		{
			...
			worlditem.OnCollisionsEnabledChange += OnCollisionsEnabledChange;
		...
		public void OnAddedToGroup ()
		{
			...
			if (worlditem.IsNObject && worlditem.NObject.isMine) {
				...
				terrainHit.groundedHeight = State.MotileProps.GroundedHeight;//Mathf.Max (Globals.DefaultCharacterGroundedHeight, State.MotileProps.GroundedHeight) * 2f;
		...
		protected Quaternion mVisibleRotation = Quaternion.identity;
