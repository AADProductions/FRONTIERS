...
namespace Frontiers.GUI
{
	...
	public class GUICursor : InterfaceActionFilter
	{
		...
		#if UNITY_EDITOR
		//used for testing with inspector
		...
		public void OnDrawGizmos()
		{
			...
			if (CurrentSearches.Count > 0) {
				...
				for (int i = 0; i < CurrentSearches.Count; i++) {
					...
					TextGizmo.Draw(SearchCamera, worldBounds.center + Vector3.up * 0.01f, s.Widget.Flag.ToString());
		...
		protected double mPressIntervalShort = 0.08f;
		protected double mPressInterval = 0.175f;
