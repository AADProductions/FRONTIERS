...
namespace Frontiers.GUI
{
 ...
 DebugLabel.enabled = false;
		...
		protected void SendCharacterCameraToCharacter ()
		{
			...
			Transform headTransform = Conversation.LastInitiatedConversation.CameraTarget;
			...
			if (HeadLight == null && !Conversation.LastInitiatedConversation.IsUsingIntermediary) {
