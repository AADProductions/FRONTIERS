...
public class UpdateManager : MonoBehaviour
{
	...
	void UpdateList (List<UpdateEntry> list, double delta)
	{
	...
	void Start ()
	{
		...
		{
			mTime = Frontiers.WorldClock.RealTime;//Time.realtimeSinceStartup;
	...
	void Update ()
	{
		...
		else UpdateList (mOnUpdate, Frontiers.WorldClock.RTDeltaTime);
	}
	...
	void LateUpdate ()
	{
		UpdateList (mOnLate, Frontiers.WorldClock.RTDeltaTime);
