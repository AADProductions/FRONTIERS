...
public class InvDatabase : MonoBehaviour
{
	...
	static public InvDatabase[] list
	{
		get
		{
			...
			{
				mIsDirty = false;
				mList = GameObject.FindObjectsOfType(typeof(InvDatabase)) as InvDatabase[];

				// Alternative method, considers prefabs:
				//mList = UnityEngine.Resources.FindObjectsOfTypeAll(typeof(InvDatabase)) as InvDatabase[];
			}
			return mList;
		}
	}
