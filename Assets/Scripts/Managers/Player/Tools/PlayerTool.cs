...
namespace Frontiers
{
		...
		public class PlayerTool : PlayerScript
		{
				...
				{
						WorldItemUsable usable = worlditem.gameObject.GetOrAdd <WorldItemUsable>();
				...
				protected IEnumerator UseStartSwing(Weapon weapon)
				{
						...
						Player.Get.AvatarActions.ReceiveAction(AvatarAction.ToolUse, WorldClock.AdjustedRealTime);
				...
				{
						//this has been moved to PlayerItemPlacement
				}
				...
				protected bool WaitingForImpact = false;
