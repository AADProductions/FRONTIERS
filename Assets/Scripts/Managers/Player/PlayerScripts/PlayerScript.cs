...
namespace Frontiers
{
		//this is very similar to WIScript in that it has a 'State' object that gets saved when the player state is saved
		//so the player is like a very big very complex WorldItem
