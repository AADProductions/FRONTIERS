...
namespace Frontiers
{
	public class PlayerSurroundings : PlayerScript, IPhotosensitive
	{
		...
		public bool IsRecepticleInPlayerFocus {
			get {
				return RecepticleInPlayerFocus != null;
			}
		}

		public bool IsRecepticleUnderGrabber {
			get {
				return RecepticleUnderGrabber != null;
			}
		}
		...
		public Recepticle RecepticleInPlayerFocus;
		public Recepticle RecepticleUnderGrabber;
		...
		public void PilgrimStopVisit (PilgrimStop pilgrimStop)
		{
			...
			if (!PilgrimStops.Contains (pilgrimStop)) {
				//Debug.Log ("Added pilgrim stop " + pilgrimStop.name);
...
//			}
		...
		{
			//these notifcations are no longer necessary thanks to other GUI elements
		...
		public void ClearSurroundings ()
		{
			...
			RecepticleInPlayerFocus	= null;
			RecepticleUnderGrabber = null;
		}
		...
		RaycastHit worldItemHit;
		RaycastHit terrainHit;
		RaycastHit[] sphereCastHits;
		IItemOfInterest focusItemOfInterest = null;
		...
		public void RaycastAllFocus ()
		{
			...
			if (IsWorldItemInPlayerFocus) {
				RecepticleInPlayerFocus = WorldItemFocus.worlditem.Get <Recepticle> ();
			}
		}
		...
		RaycastHit hitUp;
		IItemOfInterest upItemOfInterest = null;
