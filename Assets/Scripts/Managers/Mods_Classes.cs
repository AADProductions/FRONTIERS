...
namespace Frontiers
{
	...
	public class PlayerStartupPosition : Mod
	{
		...
		public bool ForceUnloadAllNonPrimaryChunks = false;
	...
	public class TreeInstanceTemplate : IHasPosition
	{
		...
		public TreeInstance	ToInstance {
			get {
				gTreeTemplate.lightmapColor = Color.white;
				gInstanceColor.r = R;
				gInstanceColor.g = G;
				gInstanceColor.b = B;
				gInstanceColor.a = A;
				gTreeTemplate.color = gInstanceColor;
				gInstancePosition.x = X;
				gInstancePosition.y = Y;
				gInstancePosition.z = Z;
				gTreeTemplate.position = gInstancePosition;
				gTreeTemplate.heightScale = HeightScale;
				gTreeTemplate.widthScale = WidthScale;
				gTreeTemplate.prototypeIndex = FinalPrototypeIndex;
				return gTreeTemplate;
			}
		}
		...
		protected static TreeInstance gTreeTemplate;
	}
