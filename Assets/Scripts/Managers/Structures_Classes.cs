...
namespace Frontiers
{
	...
	public class StructurePack
	{
		...
		//objects with meshes that shouldn't have mesh colliders applied to them
		public List <GameObject> MeshColliderPrefabs = new List <GameObject> ();
		public List <Mesh> LODMeshes = new List <Mesh> ();
		[NonSerialized]
		public Dictionary <GameObject, Mesh>
			LODMeshLookup = new Dictionary<GameObject, Mesh> ();
		[NonSerialized]
		public Dictionary <string, StructurePackPrefab>
			StaticPrefabLookup = new Dictionary <string, StructurePackPrefab> ();
		[NonSerialized]
		public Dictionary <string, DynamicPrefab>
			DynamicPrefabLookup = new Dictionary <string, DynamicPrefab> ();
	}
	...
	public class MinorStructure
	{
		...
		[XmlIgnore]
		public MinorStructureContainer
			Container;
		...
		public int
			Number = 0;
		[XmlIgnore]
		public StructureLoadState
			LoadState = StructureLoadState.ExteriorUnloaded;
		[XmlIgnore]
		public List <MeshFilter>
			ExteriorMeshes;
		[XmlIgnore]
		...
		[XmlIgnore]
		public List <Renderer>
			ExteriorLODRenderers;
		[XmlIgnore]
		public List <Renderer>
			ExteriorRenderersDestroyed;
		[XmlIgnore]
		public List <Renderer>
			ExteriorLODRenderersDestroyed;
		[XmlIgnore]
		public List <StructureTerrainLayer>
			ExteriorLayers;
		[XmlIgnore]
		public List <Collider>
			ExteriorColliders;
		[XmlIgnore]
		public List <BoxCollider>
			ExteriorBoxColliders;
		[XmlIgnore]
		public List <MeshCollider>
			ExteriorMeshColliders;
		[XmlIgnore]
		public WorldChunk
			Chunk;
	...
	public class WorldItemPack : IComparable <WorldItemPack>
	{
		...
		[NonSerialized]
		protected Dictionary <string, WorldItem>
			mWorldItemPrefabLookup = new Dictionary <string, WorldItem> ();
	}
}