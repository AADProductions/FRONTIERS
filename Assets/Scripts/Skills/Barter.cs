...
namespace Frontiers.World.Gameplay
{
	...
	{
		public static int BarterFlavor = 0;
		public static int BuyFlavor = 1;
		...
		protected void SpawnBarterDialog ()
		{
			...
			mCurrentSession.InfoDisplay = BarterInterface;
		...
		public void StopBartering ()
		{
			...
			mCurrentSession.ClearGoodsAndCurrency ();
			mStopping = false;
			mIsInUse = false;
		}
	...
	public class BarterSession
	{
		...
		public int NumCharacterGoods {
			get {
				int numGoods = 0;
				for (int i = 0; i < CharacterGoods.Count; i++) {
					numGoods += CharacterGoods [i].NumItems;
				}
				return numGoods;
			}
		}

		public int NumPlayerGoods {
			get {
				int numGoods = 0;
				for (int i = 0; i < PlayerGoods.Count; i++) {
					numGoods += PlayerGoods [i].NumItems;
				}
				return numGoods;
			}
		}
		...
		public int CharacterBalance {
			get {
				return TotalValueCharacterGoods - TotalValuePlayerGoods;
			}
		}
		...
		public IInfoDisplay InfoDisplay;
