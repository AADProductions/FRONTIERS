...
public static class Globals
{
	...
	[WorldSetting]
	public static string BanditCampDefaultFleeSpeech = "Bandit-01-Enc-Bandit-Flee-Dts-01";
	[WorldSetting]
	public static string BanditCampDefaultTauntSpeech = "Bandit-01-Enc-Bandit-Taunt-Dts-01";
	[WorldSetting]
	public static string BanditCampDefaultAttackSpeech = "Bandit-01-Enc-Bandit-Attack-Dts-01";
	[WorldSetting]
	public static string BanditCampDefaultWarningSpeech = "Bandit-01-Enc-Bandit-Warn-Dts-01";
	[WorldSetting]
	public static string SpeechOnPlayerEncounterRepTerrible = "Npc-Enc-Reputation-Terrible-Dts-01";
	[WorldSetting]
	public static string SpeechOnPlayerEncounterRepLow = "Npc-Enc-Reputation-Low-Dts-01";
	[WorldSetting]
	public static string SpeechOnPlayerEncounterRepDecent = "Npc-Enc-Reputation-Decent-Dts-01";
	[WorldSetting]
	public static string SpeechOnPlayerEncounterRepHigh = "Npc-Enc-Reputation-High-Dts-01";
	[WorldSetting]
	public static string SpeechOnPlayerEncounterRepPerfect = "Npc-Enc-Reputation-Perfect-Dts-01";
	[WorldSetting]
	public static string SpeechOnPlayerEnterResidenceUnknown = "Npc-Enc-Residence-Enter-Unknown-Dts-01";
	[WorldSetting]
	public static string SpeechOnPlayerEnterResidenceKnown = "Npc-Enc-Residence-Enter-Known-Dts-01";
